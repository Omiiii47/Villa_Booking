...
const VillaDetails = () => {
  ...
  if (!villa) return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center"><h1 className="font-display text-4xl mb-4">Villa Not Found</h1><Link href="/villas" className="btn-primary"><span>Browse Villas</span></Link></div>
    </div>
  );
