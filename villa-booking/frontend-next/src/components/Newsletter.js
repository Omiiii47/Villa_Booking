    ...
    <section className="section-padding relative overflow-hidden">
      ...
      <div className="luxury-container relative z-10">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto text-center">
          <span className="section-label text-luxury-accent">Stay Connected</span>
          <h2 className="font-display text-display-lg text-white mb-4">Join Our Concierge Circle</h2>
          <p className="text-white/50 font-light mb-10 max-w-md mx-auto">Receive exclusive offers, new villa announcements, and curated travel inspiration.</p>
          {subscribed ? (
