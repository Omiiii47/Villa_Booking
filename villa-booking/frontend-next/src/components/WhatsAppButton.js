 ...
 * Opacity/fade + scale on load, elegant hover/press states, GPU-friendly transforms.
 * Hidden behind fullscreen menus/modals via z-index stacking (they use z-60/z-100+).
 */

const WHATSAPP_NUMBER = 'YOUR_PHONE_NUMBER'; // TODO: replace with business WhatsApp number (country code, no + or spaces)
