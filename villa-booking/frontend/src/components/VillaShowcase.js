  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Link to={`/villas/${villa.slug}`} className="flex items-center gap-2">Explore Villa <FaArrowRight className="text-[10px]" /></Link>
        </motion.div>
      </motion.div>
    </motion.div>
  );
    ...
    <section className="section-padding bg-luxury-cream relative overflow-hidden">
      <div className="luxury-container">
        ...
        >
          ...
          <Magnetic>
            <Link to="/villas" className="btn-outline !px-8 !py-3.5 text-[10px]">
              <span>View All</span>
