  ...
  return (
    <section ref={ref} className="relative h-screen min-h-[750px] flex items-center justify-center overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        >
          <Magnetic>
            <Link to="/villas" className="btn-primary !bg-white !text-luxury-black hover:!text-white !px-12">
          ...
          <Magnetic>
            <Link to="/about" className="btn-outline !border-white !text-white hover:!text-white !px-12">
